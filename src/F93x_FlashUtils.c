...
void FLASH_Write (FLADDR dest, char *src, U16 numbytes, bit SFLE);
char * FLASH_Read (char *dest, FLADDR src, U16 numbytes, bit SFLE);
void FLASH_Clear (FLADDR addr, U16 numbytes, bit SFLE);

// FLASH update/copy routines
void FLASH_Update (FLADDR dest, char *src, U16 numbytes, bit SFLE);
...
void FLASH_Fill (FLADDR addr, ULONG length, U8 fill, bit SFLE)
{
   FLADDR i;
